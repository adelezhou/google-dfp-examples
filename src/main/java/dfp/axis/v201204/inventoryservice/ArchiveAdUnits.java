...
import com.google.api.ads.dfp.axis.v201204.AdUnitPage;
...
import com.google.api.ads.dfp.axis.v201204.UpdateResult;
...
public class ArchiveAdUnits {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, String parentAdUnitId)
    ...
    if (adUnitIds.size() > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201204.ArchiveAdUnits action =
          new com.google.api.ads.dfp.axis.v201204.ArchiveAdUnits();
